...
**What the front end looks like from the user’s perspective**
...
**Feature: Selecting columns in the CSV to ignore**
...
**Feature: Select a column to sort the data by**
